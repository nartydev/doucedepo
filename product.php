<?php require 'inc/header.php'; ?>
    <section class="cloud-part">
        <div class="container start-no-wrap">
			...
			<div class="fiche">
				...
				<div class="true-desc">
					<ul>
						<li><i class="fa fa-angle-right"></i> Coton-Eponge</li>
						<li><i class="fa fa-angle-right"></i> Taille: 19×19 cm (0 à 18 mois)</li>
						<li><i class="fa fa-angle-right"></i> Lavage en machine à 30°</li>
					</ul>
				</div>
			</div>
		</div>
    ...
    <section class="gradient-inverse more-product">
        <div class="container">
            <h2 class="title-products">Découvrez aussi</h2>
        </div>
