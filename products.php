<?php require 'inc/header.php'; ?>
        ...
        <div class="container start-no-wrap">
			<div class="search">
                ...
                <ul class="search-collect">
                    ...
                    <li>Attache tétine</li>
                    <li>Protège carnet de santé</li>
                    <li>Tapis à langer nomade</li>
                ...
                <div class="round-color yellow"></div>
                <div class="round-color pink"></div>
                <div class="round-color blue"></div>
    ...
    <section class="gradient-inverse more-product">
        <div class="container">
            <h2 class="title-products">Consulté récemment</h2>
        </div>
        <div class="container start">
            <div class="product">
                <div class="black"><a href="product.php" class="go-buy">Voir plus</a></div>
