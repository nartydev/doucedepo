<?php require 'inc/header.php'; ?>
        <div class="slider gradient">
            ...
            <div class="one-slide" slide-number="1">
                <div class="container content-slider">
                    <img src="assets/img/personal.png" alt="Slider 1" class="img-slider">
                    <div class="text-content-slider">
    ...
    <section class="white">
        <div class="container start">
            <div class="col">
                <div class="img-personal"></div>
                <h3>Personnalisation</h3>
                <div class="border-info"></div>
                <p>
                    Sur Douce de Po c’est vous qui choisissez l’apparence de votre produit final grâce à la personnalisation. Vous voulez un cadeau unique pour une naissance ? Vous pouvez indiquer le prénom du nouveau né sur une sélection d’objets et même choisir les motifs et les coloris des caractères. 
                </p>
            </div>
            <div class="col">
                <div class="img-local"></div>
                <h3>Fait à la main</h3>
                <div class="border-info"></div>
                <p>
    ...
    <section class="gradient-inverse">
        <div class="container">
            <h2 class="title-products">Mes produits</h2>
        </div>
        <div class="container start">
            <div class="product">
